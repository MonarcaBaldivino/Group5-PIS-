                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(usertxt, javax.swing.GroupLayout.DEFAULT_SIZE, 255, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String username = usertxt.getText();
         String password = new String(passtxt.getPassword());
            ...
            return; 
            // Exit the method if connection is null
        }
                          
                          
                    pst = con.prepareStatement("Select * from accdetails where username=? and password=?");
                    ...
                    if (rs.next()) {
                        ...
                        if ("admin".equals(role)) {
                            JOptionPane.showMessageDialog(rootPane, "Admin Login", "Login Successfull", JOptionPane.INFORMATION_MESSAGE);

                            AdminPage ad = new AdminPage();
                            ad.setVisible(true);
                            setVisible(false);
                            
                            JOptionPane.showMessageDialog(rootPane, "Login Succesfull", "Login Successfull", JOptionPane.INFORMATION_MESSAGE);

                            
                        } else if ("employee".equals(role)) {
                            JOptionPane.showMessageDialog(rootPane, "Employee Login", "Login Successfull", JOptionPane.INFORMATION_MESSAGE);

                            EmployeePage up = new EmployeePage();
                            up.setVisible(true);
                            setVisible(false);
                            JOptionPane.showMessageDialog(rootPane, "Login Successfull", "Login Successfull", JOptionPane.INFORMATION_MESSAGE);
